...
const { CreateProducts, getAllProducts, getAllProductsbyCategory,getAllProductsbyId, updateProducts, deleteProducts } = require('../../Controller/Product/productController');
