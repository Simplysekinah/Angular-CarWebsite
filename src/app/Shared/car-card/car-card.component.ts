...
import {bootstrapEvStationFill,bootstrapPeopleFill,bootstrapHeart} from '@ng-icons/bootstrap-icons'
...
@Component({
  ...
  viewProviders:[provideIcons({bootstrapEvStationFill,bootstrapPeopleFill,bootstrapHeart})]
})
